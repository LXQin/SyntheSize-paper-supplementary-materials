...
metric_generated <- read.csv("../Case/RNABRCASubtype/metric_generated_test31_xgbparam.csv", header = TRUE)
metric_real <- read.csv("../Case/RNABRCASubtype/metric_real_test31_xgbparam.csv", header = TRUE)
vis_classifier(metric_generated = metric_generated, 
               metric_real = metric_real,
               n_target = n_target,
               save_root = save_root)
