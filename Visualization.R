...
load("LAMLPositive_2_Optimal.RData")
load("PRADPositive_2_Optimal.RData")
load("BRCAPRADPositive_3_Optimal.RData")
...
pdf(file = paste("/Users/"
, dataname, "_Optimal.pdf", sep = ""), width = 8, height = 9)
print(gg_default(p))
dev.off()
...
load("SKCM_Transfer.RData")
load("BRCA_Transfer.RData")
...
pdf(file = paste("/Users/"
                 , dataname, ".pdf", sep = ""), width = 8, height = 8)
print(gg_default(p))
dev.off()


#RNA transfer
load("RNABRCASPLIT_Transfer.RData")
load("RNAPRADSPLIT_Transfer.RData")
